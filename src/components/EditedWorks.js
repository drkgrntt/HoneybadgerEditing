    ...
    <div className="widget">
      <Grid stackable>
        ...
        <Grid.Row>
          ...
          <Grid.Column width={11}>
            <div className="quote">
              <p><em>"For literally all of your writing endeavors (books, essays, short stories, papers for school, resumes, letters to the President, anonymous love letters, etc.), I cannot recommend Honeybadger Editing services highly enough. Professional work at a personal level with affordable prices."</em></p>
              <p>-Mark Garnett, Author</p>
              <hr />
              <h3><a
